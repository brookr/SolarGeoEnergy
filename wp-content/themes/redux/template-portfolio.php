...
<?php get_header(); ?>
			...
			<div id="portfolio-wrap">
                ...
                <!--BEGIN #columns-wrap-->
            	<ul id="columns-wrap" class="image-grid-one">
                    ...
                    <li data-id="id-<?php echo $count; ?>" class="<?php if($terms) : foreach ($terms as $term) { echo 'term-'.$term->term_id.' '; } endif; ?>">
                        ...
                        <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">	
                            ...
                            <div class="post-thumb">
                                <a title="<?php printf(__('Permanent Link to %s', 'framework'), get_the_title()); ?>" href="<?php the_permalink(); ?>"><?php the_post_thumbnail('portfolio-one-col'); /* post thumbnail settings configured in functions.php */ ?></a>
                            </div>
                            <?php } ?>
