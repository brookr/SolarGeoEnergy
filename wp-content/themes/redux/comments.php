...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond" class="clearfix">
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<label for="email"><small><?php _e('Email', 'framework') ?><span> <?php if ($req) _e("*", 'framework'); ?></span> <span class="grey"><?php _e('(never pulished)', 'framework'); ?></span> </small></label></p>
			...
			<p>
            	<button class="alt_btn" type="submit" name="submit">
                    <span class="left"><span class="right"><?php _e('Submit Comment', 'framework'); ?></span></span>
                </button>
